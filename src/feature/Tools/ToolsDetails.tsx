...
import { useGetToolQuery, useDeleteToolMutation } from "@/redux/api/Tools/toolsApi";
...
//   get affilate details apis 

// const { data: affiliateData } = useGetAffiliateDetailsQuery();
// console.log("affial data ", affiliateData)

  // Debugging logs
  console.log("Logged-in user:", user);
  console.log("Single user data:", singleUser);
  console.log("Tool data:", toolData);
  console.log("Founder ID check:", {
    userRoleDataId: singleUser?.data?.roleData?._id,
    toolFounderId: toolData?.data?.founderId,
    isMatch: singleUser?.data?.roleData?._id === toolData?.data?.founderId,
  });
